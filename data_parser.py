...
def parseJson(json_file):
    ...
    with open(json_file, 'r') as f:
        ...
        with open('unsorted_items.dat', 'a') as item_data, open('bids.dat', 'a') as bids_data, open('unsorted_users.dat', 'a') as user_data, open('categories.dat', 'a') as category_data:
            for item in items:
